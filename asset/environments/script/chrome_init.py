...
def chrome_init(avd_name='pixel_3_train_00'):
    ...
    while attempt < 5:
        try:
            terms_accept_UI = driver.find_element(by=AppiumBy.ID, value="com.android.chrome:id/terms_accept")
    ...
    while attempt < 5:
        try:
            skip_signin_UI = driver.find_element(by=AppiumBy.ID, value="com.android.chrome:id/negative_button")
